...
class VAESyncTrainer:
    ...
    def fit(self,model,optimizer,scheduler,criterion,train_loader,eval_loader,test_loader,device,early_stopping=None):
        ...
        for epoch in range(self.config["init_epoch"], num_epochs):
            ...
            train_recon_skeleton_loss_list.append(train_loss['recon_loss_skeleton'])
            train_recon_text_loss_list.append(train_loss['recon_loss_text'])
            train_kl_skeleton_loss_list.append(train_loss['kl_loss_skeleton'])
            train_kl_text_loss_list.append(train_loss['kl_loss_text'])
            train_kl_skeleton_aux_loss_list.append(train_loss['kl_loss_skeleton_aux'])
            train_kl_text_aux_loss_list.append(train_loss['kl_loss_text_aux'])

            eval_loss_list.append(eval_loss['loss'])
            eval_recon_skeleton_loss_list.append(eval_loss['recon_loss_skeleton'])
            eval_recon_text_loss_list.append(eval_loss['recon_loss_text'])
            eval_kl_skeleton_loss_list.append(eval_loss['kl_loss_skeleton'])
            eval_kl_text_loss_list.append(eval_loss['kl_loss_text'])
            eval_kl_skeleton_aux_loss_list.append(eval_loss['kl_loss_skeleton_aux'])
            eval_kl_text_aux_loss_list.append(eval_loss['kl_loss_text_aux'])

            test_loss_list.append(test_loss['loss'])
            test_recon_skeleton_loss_list.append(test_loss['recon_loss_skeleton'])
            test_recon_text_loss_list.append(test_loss['recon_loss_text'])
            test_kl_skeleton_loss_list.append(test_loss['kl_loss_skeleton'])
            test_kl_text_loss_list.append(test_loss['kl_loss_text'])
            test_kl_skeleton_aux_loss_list.append(test_loss['kl_loss_skeleton_aux'])
            test_kl_text_aux_loss_list.append(test_loss['kl_loss_text_aux'])

            print(f"Epoch {epoch+1}/{num_epochs})")
            print(f"Train Loss: {train_loss['loss']:.4f}, Recon Skeleton Loss: {train_loss['recon_loss_skeleton']:.4f}, Recon Text Loss: {train_loss['recon_loss_text']:.4f}, KL Skeleton Loss: {train_loss['kl_loss_skeleton']:.4f}, KL Text Loss: {train_loss['kl_loss_text']:.4f}, KL Skeleton Aux Loss: {train_loss['kl_loss_skeleton_aux']:.4f}, KL Text Aux Loss: {train_loss['kl_loss_text_aux']:.4f}")
            print(f"Eval Loss: {eval_loss['loss']:.4f}, Recon Skeleton Loss: {eval_loss['recon_loss_skeleton']:.4f}, Recon Text Loss: {eval_loss['recon_loss_text']:.4f}, KL Skeleton Loss: {eval_loss['kl_loss_skeleton']:.4f}, KL Text Loss: {eval_loss['kl_loss_text']:.4f}, KL Skeleton Aux Loss: {eval_loss['kl_loss_skeleton_aux']:.4f}, KL Text Aux Loss: {eval_loss['kl_loss_text_aux']:.4f}")
            print(f"Test Loss: {test_loss['loss']:.4f}, Recon Skeleton Loss: {test_loss['recon_loss_skeleton']:.4f}, Recon Text Loss: {test_loss['recon_loss_text']:.4f}, KL Skeleton Loss: {test_loss['kl_loss_skeleton']:.4f}, KL Text Loss: {test_loss['kl_loss_text']:.4f}, KL Skeleton Aux Loss: {test_loss['kl_loss_skeleton_aux']:.4f}, KL Text Aux Loss: {test_loss['kl_loss_text_aux']:.4f}")


            #eval_lossとtest_lossのkeyを変更
            eval_loss = {
                "eval_loss": eval_loss['loss'],
                "eval_recon_skeleton_loss": eval_loss['recon_loss_skeleton'],
                "eval_recon_text_loss": eval_loss['recon_loss_text'],
                "eval_kl_skeleton_loss": eval_loss['kl_loss_skeleton'],
                "eval_kl_text_loss": eval_loss['kl_loss_text'],
                "eval_kl_skeleton_aux_loss": eval_loss['kl_loss_skeleton_aux'],
                "eval_kl_text_aux_loss": eval_loss['kl_loss_text_aux'],
            }
            test_loss = {
                "test_loss": test_loss['loss'],
                "test_recon_skeleton_loss": test_loss['recon_loss_skeleton'],
                "test_recon_text_loss": test_loss['recon_loss_text'],
                "test_kl_skeleton_loss": test_loss['kl_loss_skeleton'],
                "test_kl_text_loss": test_loss['kl_loss_text'],
                "test_kl_skeleton_aux_loss": test_loss['kl_loss_skeleton_aux'],
                "test_kl_text_aux_loss": test_loss['kl_loss_text_aux'],
            }
